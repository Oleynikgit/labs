...
1. Установка Hugo
2. Установка хуго в терминале
3. Создание шаблона
4. Добавление шаблона в репозиторий
5. Команда hugo server
6. Демонстрация локального сайта(hugo server)
7. Добавляем второй репозиторий,чтобы наш сайт работал на других ПК
8. Подключаем репозиторий к public
9. Наш сайт готов :)
